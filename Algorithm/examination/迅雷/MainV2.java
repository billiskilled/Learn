...
public class MainV2 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ArrayList<Integer>> resultArray = makeArr(1 , arr);
    ...
    public static ArrayList<ArrayList<Integer>> makeArr (int level, ArrayList<ArrayList<Integer>> arr) {
        if (level == 17) {
